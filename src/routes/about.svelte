...
<div class="aboutpage">
    ...
    <div class="resume" id="resume">
        ...
        <a href="https://drive.google.com/uc?export=download&id=1YFeD-h-zyrPsRHg64NnDQr0ZjdhDbkL-">
...
<style>
    ...
    h1{
        font-size: 3rem;
        background: linear-gradient(-35deg, #fcfcfc91, #ffffff, #ffffff11,#eeeeeefb,#ffffff7c);
